...
export default function TopNav() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-gray-900 border-b border-gray-700 backdrop-blur-md">
        <div className="max-w-[1440px] mx-auto px-6 flex items-center h-14">
          {/* Logo */}
